...
- **Project Metadata**
    - Group: uk.ac.mmu.sda.sda
    - Artifact: lab0901
    - Name: lab0901
    - Package name: uk.ac.mmu.sda.sda.lab0901
    - Packaging: Jar
...
lab0901.uk.ac.mmu.sda.sda.Lab0901Application     : Starting Lab0901Application
lab0901.uk.ac.mmu.sda.sda.Lab0901Application     : No active profile set, falling back to 1 default profile: "default"
lab0901.uk.ac.mmu.sda.sda.Lab0901Application     : Started Lab0901Application in 0.506 seconds (process running for 0.767)
```
...
```
You should see the message `Hello from class uk.ac.mmu.sda.lab0901.Runner01` appear in the console when you run the application. This shows that the Spring Boot application is running correctly.
...
Copy the `applicationcode` and `infrastructure` packages from the **ShippingCostPortsAdaptors** project in Student code repository to the `uk.ac.mmu.sda.lab0901` package in your Spring Boot project.
...
- **Project Metadata**
    - Group: uk.ac.mmu.sda
        ...
        - Package name: uk.ac.mmu.sda.lab0902
        - Packaging: Jar
        - Configuration: Properties
        - Java: 25 (or higher)
- **Dependencies**: No dependencies are required for this lab.
...
lab0902.uk.ac.mmu.sda.sda.Lab0902Application     : Starting Lab0902Application
lab0902.uk.ac.mmu.sda.sda.Lab0902Application     : No active profile set, falling back to 1 default profile: "default"
lab0902.uk.ac.mmu.sda.sda.Lab0902Application     : Started Lab0902Application in 0.519 seconds (process running for 0.769)
```
